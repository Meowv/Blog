...
{
    public class MeowvBlogDbMigrationService : ITransientDependency
    {
        public ILogger<MeowvBlogDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IMeowvBlogDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public MeowvBlogDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IMeowvBlogDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<MeowvBlogDbMigrationService>.Instance;
        }
