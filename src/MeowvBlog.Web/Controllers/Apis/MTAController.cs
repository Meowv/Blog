...
namespace MeowvBlog.Web.Controllers.Apis
{
    ...
    public class MTAController : ControllerBase
    {
        ...
        public MTAController()
        {
            _mtaService = PlusEngine.Instance.Resolve<IMtaService>();
        }
        ...
        {
            var result = await _mtaService.Ctr_realtime(idx);
        ...
        {
            var result = await _mtaService.Ctr_realtime_heartbeat();
        ...
        {
            var result = await _mtaService.Ctr_user_realtime(page);
        ...
        {
            var result = await _mtaService.Ctr_user_compare(start_date, end_date);
        ...
        {
            var result = await _mtaService.Ctr_user_portrait(start_date, end_date, idx);
        ...
        {
            var result = await _mtaService.Ctr_area(type_ids, start_date, end_date, idx);
        ...
        {
            var result = await _mtaService.Ctr_area_province(type_ids, start_date, end_date, idx);
        ...
        {
            var result = await _mtaService.Ctr_operator(type_ids, start_date, end_date, idx);
        ...
        {
            var result = await _mtaService.Ctr_client_para(start_date, end_date, type_id, idx);
        ...
        {
            var result = await _mtaService.Ctr_client_content(start_date, end_date, type_id, type_contents, idx);
        ...
        {
            var result = await _mtaService.Ctr_page_realtime(idx);
        ...
        {
            var result = await _mtaService.Ctr_page_offline(start_date, end_date, page, idx);
        ...
        {
            var result = await _mtaService.Ctr_page_url(start_date, end_date, urls, idx);
        ...
        {
            var result = await _mtaService.Ctr_page_speed(start_date, end_date, type_contents, type, idx);
        ...
        {
            var result = await _mtaService.Ctr_page_depth(start_date, end_date);
        ...
        {
            var result = await _mtaService.Ctr_source_out(urls, start_date, end_date, idx);
        ...
        {
            var result = await _mtaService.Ctr_page_land(urls, start_date, end_date);
        ...
        {
            var result = await _mtaService.Ctr_page_exit(urls, start_date, end_date);
        ...
        {
            var result = await _mtaService.Ctr_custom(custom, start_date, end_date, idx);
        ...
        {
            var result = await _mtaService.Ctr_adtag(start_date, end_date, adtags, idx);
